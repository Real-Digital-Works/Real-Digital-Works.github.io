        ...
        <div className="wrap grid gap-12 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <aside className="glass h-fit rounded-[22px] p-8">
            <dl className="space-y-5">
              <div>
                <dt className="text-[13.5px] text-white/50">Call</dt>
                <dd className="mt-1 text-lg font-medium">
                  <a href={site.phoneHref}>{site.phone}</a>
                </dd>
              </div>
              <div>
                <dt className="text-[13.5px] text-white/50">WhatsApp</dt>
                <dd className="mt-1 text-lg font-medium">
                  <a href={site.whatsappHref}>{site.whatsapp}</a>
                </dd>
              </div>
              <div>
                <dt className="text-[13.5px] text-white/50">Email</dt>
                <dd className="mt-1 text-lg font-medium">
                  <a href={site.emailHref}>{site.email}</a>
                </dd>
              </div>
              <div>
                <dt className="text-[13.5px] text-white/50">Studio</dt>
                <dd className="mt-1 text-lg font-medium">
              ...
              <div>
                <dt className="text-[13.5px] text-white/50">Hours</dt>
                <dd className="mt-1 text-lg font-medium">{site.hours}</dd>
              </div>
              <div>
                <dt className="text-[13.5px] text-white/50">Parent company</dt>
